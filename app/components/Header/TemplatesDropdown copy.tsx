            ...
            {({open, close}) => (
              <>
                <PopoverButton
                  className={`
                  ${open ? '' : 'text-slate-700 '}
                  group py-2 h-10 sm:h-12 flex items-center rounded-md text-base font-medium dark:text-slate-300 dark:hover:text-slate-300 hover:text-slate-900 focus:outline-none focus-visible:ring-0`}
                >
